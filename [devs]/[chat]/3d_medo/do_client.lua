-- Settings
local color = { r = 255, g = 128, b = 0, alpha = 255 } -- Color of the text 
...
function DisplayDo(mePlayer, text, offset, source)
    ...
    if chatMessage then
        ...
        if dist < 2500 then
            TriggerEvent('chat:addMessage', {
                ...
                template = '<div style="padding: 0.1vw; margin: 0.1vw; color: rgba(255, 128, 0, 0.9); border-radius: 3px;">[DO] {0}: {1}</div>',
