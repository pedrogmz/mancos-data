...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', '247', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', '247', _U('247_customer'), true, true)
TriggerEvent('esx_society:registerSociety', '247', '247', 'society_247', 'society_247', 'society_247', {type = 'private'})
        ...
        SetTimeout(10000, function()        
            ...
            elseif gimelQuantity < 2 then
                ...
                if chanceToMiss <= Config.MissCraft then
                    ...
                    xPlayer.removeInventoryItem('steak', 1)
                    xPlayer.removeInventoryItem('cheese', 2)
                    xPlayer.addInventoryItem('247', 1)
                end
            end
