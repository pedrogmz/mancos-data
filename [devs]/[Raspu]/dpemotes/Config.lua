...
Config.Languages = {
  ['en'] = {
        ...
        ['sentrequestto'] = "Enviado a ~y~",
        ['nobodyclose'] = "No hay nadie ~r~cerca~w~.",
        ['doyouwanna'] = "~g~H~w~ para ~g~aceptar~w~, ~r~L~w~ para ~r~declinar~w~ (~g~",
        ['refuseemote'] = "Denegado.",
        ['makenearby'] = "makes the nearby player play",
        ['camera'] = "~y~G~w~ para usar el flash.",
        ['makeitrain'] = "~y~G~w~ para que llueva.",
        ['pee'] = "~y~G~w~ para orinar.",
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
