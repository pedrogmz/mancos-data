...
Config.NPCJobEarnings             = { min = 95, max = 110 } -- modificar en server/main.lua linea: 230
Config.Locale                     = 'es'

Config.Zones = {
--mecanico acciones
	  MecanoActions = {
		Pos   = { x = -346.31, y = -133.56, z = 38.01 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 182, g = 3, b = 249 },
		Type  = 1,
	  },
  
	VehicleRepair = {
		Pos   = { x = -324.74, y = -138.48, z = 37.3 },
...
--[[	VehicleRepair4 = {
 ...
 --[[  Garage = {
     Pos   = { x = 2344.8, y = 3114.56, z = 48.21 },
     Size  = { x = 1.5, y = 1.5, z = 1.0 },
     Color = { r = 204, g = 204, b = 0 },
     Type  = 1,
   },
  ...
  Craft = {
    Pos   = { x = -1160.51, y = -1717.34, z = 3.45 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  }, ]]--
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -358.71, y = -113.88, z = 38.7 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -358.71, y = -113.88, z = 37.7 },
    Size  = { x = 3.0, y = 3.0, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  },
