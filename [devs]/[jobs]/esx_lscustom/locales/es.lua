Locales['es'] = {
  ...
  ['not_enough_money'] = 'no tienes para pagartelo!',
  ['purchased'] = 'lo has comprado!',
  ['press_custom'] = 'Pulsa ~INPUT_PICKUP~ para ~y~personalizar~s~ tu vehiculo.',
  ['level'] = 'nivel %s',
  ['neon'] = 'neon',
  ['blip_name'] = 'Los Santos Tunning',
-- Paint Colors
  -- Black
  ['black'] = 'negro',
  ['graphite'] = 'grafito',
...
-- Cosmetics
  ...
  ['quarter_deck'] = 'cubierta',
  ['speakers'] = 'parlantes',
  ['trunk'] = 'maletero',
  ['hydraulic'] = 'hidraulica',
  ['engine_block'] = 'bloqueo del motor',
