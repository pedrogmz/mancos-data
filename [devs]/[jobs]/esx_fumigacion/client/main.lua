...
function MenuVehicleSpawner()
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu)
			ESX.Game.SpawnVehicle(data.current.value, Config.Zones.VehicleSpawnPoint.Pos, 27.14, function(vehicle)
				...
				if data.current.value == 'phantom3' then
					ESX.Game.SpawnVehicle("trailers2", Config.Zones.VehicleSpawnPoint.Pos, 27.14, function(trailer)
...
function MissionLivraisonSelect()
	...
	elseif MissionRegion == 2 then -- Blaine County
		...
		elseif MissionNum == 5 then destination = Config.Livraison.Delivery5BC namezone = "Delivery5BC" namezonenum = 3 namezoneregion = 2
