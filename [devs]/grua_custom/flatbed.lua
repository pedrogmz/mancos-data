...
AddTextEntry(controllerMessageLoweredCar, "Presiona ~INPUT_CONTEXT~ para ~y~bajar ~w~la grúa.~n~Presiona ~INPUT_DETONATE~ para ~r~soltar ~w~el vehículo.")
AddTextEntry(controllerMessageLoweredNoCar, "Presiona ~INPUT_CONTEXT~ para ~y~bajar ~w~la grúa.~n~Presiona ~INPUT_DETONATE~ para ~g~enganchar ~w~el vehículo.")
AddTextEntry(controllerMessageRaised, "Presiona ~INPUT_CONTEXT~ para ~y~bajar ~w~la grúa.")
