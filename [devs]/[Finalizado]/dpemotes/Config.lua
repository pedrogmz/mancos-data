...
-- You can disable the (F3) menu here / change the keybind.
	...
	MenuKeybind = 182, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://pda.rp.mancos.games/views/images/loadscreen.jpg",
...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Animaciones',
        ['danceemotes'] = "🕺 Animaciones de baile",
        ['propemotes'] = "📦 Animaciones de Objeto",
        ['favoriteemotes'] = "🌟 Favoritas",
        ['favoriteinfo'] = "Seleccione una animación aquí para configurarlo como su favorito.",
        ['rfavorite'] = "Restablecer favorito",
        ['prop2info'] = "❓ Prop Emotes se puede ubicar al final",
        ['set'] = "Establecer (",
        ['setboundemote'] = ") ser tu emote enlazado?",
        ['newsetemote'] = "~w~ ahora es tu emote enlazado, presione ~g~Bloq Mayús~w~ para usarlo",
        ['cancelemote'] = "Cancelar animación",
        ['cancelemoteinfo'] = "~r~X~w~ Cancela la animación que se está reproduciendo actualmente",
        ['walkingstyles'] = "Estilos de caminar",
        ['resetdef'] = "Restablecen a los predeterminados",
        ['normalreset'] = "Normal (Reiniciar)",
        ['moods'] = "Modo",
        ['infoupdate'] = "Información",
        ['infoupdateav'] = "Información (Actualización disponible)",
        ['infoupdateavtext'] = "Hay una actualización disponible, obtenga la última versión de ~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "Sugerencias?",
        ['suggestionsinfo'] = "'dullpear_dev' en los foros de FiveM para cualquier sugerencia de función / emote ✉️",
        ['notvaliddance'] = "no es un baile válido.",
        ['notvalidemote'] = "no es una animación válida.",
        ['nocancel'] = "Sin emoticones para cancelar.",
        ['maleonly'] = "Este emote es solo masculino, lo siento.",
        ['emotemenucmd'] = "Realiza /emotemenu para un menú",
        ['shareemotes'] = "👫 Emotes compartidos",
        ['shareemotesinfo'] = "Invita a una persona cercana a que emote",
        ['sharedanceemotes'] = "🕺 Bailes compartidas",
        ['notvalidsharedemote'] = "no es una animación compartida válida.",
        ['sentrequestto'] = "Solicitud enviada a ~y~",
        ['nobodyclose'] = "Nadie cerca :( ~r~cerrar~w~",
        ['doyouwanna'] = "~y~H~w~ para aceptar, ~r~L~w~ para rechazar (~g~",
        ...
        ['pee'] = "Mantén pulsado ~y~G~w~ para orinar.",
        ['spraychamp'] = "Mantén pulsado ~y~G~w~ para rociar champán.",
        ['bound'] = "Ligado ",
        ['to'] = "a",
        ['currentlyboundemotes'] = " Animaciones vinculadas actualmente:",
        ['notvalidkey'] = "no es una tecla válida.",
        ['keybinds'] = "🔢 Teclas vinculadas",
        ['keybindsinfo'] = "Usar"
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
