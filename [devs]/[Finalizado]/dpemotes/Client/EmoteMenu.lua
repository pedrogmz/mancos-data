...
if Config.CustomMenuEnabled then
  ...
  local Object = CreateDui(Config.MenuImage, 340, 128)
  _G.Object = Object
...
mainMenu = NativeUI.CreateMenu("Mancos Emotes", "", menuPosition["x"], menuPosition["y"], Menuthing, Menuthing)
...
function AddInfoMenu(menu)
    ...
    u170 = NativeUI.CreateItem("1.7.0", "Añadido /emotebind [key] [emote]!")
    u165 = NativeUI.CreateItem("1.6.5", "Actualizado camera/phone/pee/beg, añadido hacer llover /dance(glowstick/horse).")
    u160 = NativeUI.CreateItem("1.6.0", "Agregadas animaciones compartidas /nearby, o en el menú, también arreglamos algunos gestos!")
    u151 = NativeUI.CreateItem("1.5.1", "Añadido /walk y /walks, para caminar estilos sin menú.")
    u150 = NativeUI.CreateItem("1.5.0", "Menú de expresiones faciales agregado (si lo habilita el propietario del servidor)")
