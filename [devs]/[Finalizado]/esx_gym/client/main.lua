    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'gym_menu',
        {
            ...
            elements = {
				...
				{label = 'Carné de gimnasio', value = 'ship'},
            }
        },
        function(data, menu)
            ...
            elseif data.current.value == 'hours' then
				...
				ESX.ShowNotification("Estamos abiertos ~g~24~w~ horas. ¡Bienvenido!")
...
function OpenGymShipMenu()
    ...
    ESX.UI.Menu.Open(
        ...
        {
            title    = 'Gym - Carné de gimnasio',
            elements = {
				{label = 'Carné de gimnasio ($800)', value = 'membership'},
            }
        },
        function(data, menu)
