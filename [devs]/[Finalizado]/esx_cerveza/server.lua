...
elseif cebada < 1 then
	TriggerClientEvent('esx:showNotification', source, '~r~No tienes cebada para vender')
...
elseif trigo < 1 then
	TriggerClientEvent('esx:showNotification', source, '~r~No tienes trigo para vender')
