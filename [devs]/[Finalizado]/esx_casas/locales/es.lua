Locales['es'] = {
  ...
  ['property'] = 'Propiedad',
  ['enter'] = 'Entrar',
  ['leave'] = 'Cancelar alquiler',
  ['buy'] = 'Comprar',
  ['rent'] = 'Alquilar',
  ['visit'] = 'Visitar',
  ['press_to_menu'] = '~INPUT_CONTEXT~ para acceder al menú',
  ...
  ['removed_cloth'] = 'Has ~r~quitado~w~ las prendas de tu armario.',
  ...
  ['press_to_exit'] = '~INPUT_CONTEXT~ para salir de la propiedad',
