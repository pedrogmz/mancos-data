...
MFF.TextAddons = {
  ["LockpickDoor"] = "usar la ganzúa en la puerta.",
  ["LootID"] = "buscar una tarjeta de identificación bancaria.",
  ["OpenVault"] = "solicitar acceso a la caja fuerte.",
  ["LootVault"] = "abrir la caja fuerte.",
}
