...
Config.BlipNameOnMap = "Misión Furgón Blindado"		-- set name of the blip
...
Config.BlipNameForTruck = "Furgón Blindado"			-- set name of the blip
...
Config.Draw3DText = "Pulsa ~g~[E]~s~ para la ~y~Misión~s~"					-- set your desired text here
...
Config.NoMissionsAvailable = "No hay ~y~misiones~s~ disponibles este momento, prueba más tarde!"
Config.HackingFailed = "Has ~r~fallado~s~ el hackeo~s~"
Config.TruckMarkedOnMap = "~y~Furgón Blindado~s~ marcado en tu mapa!"
Config.KillTheGuards = "~r~Mata~s~ los guardias del ~y~Furgón Blindado~s~"
Config.MissionCompleted = "~g~Misión Completada:~s~ Has ~r~robado~s~ el ~y~Furgón Blindado~s~!"
Config.BeginToRobTruck = "Ve al ~y~Furgón Blindado~s~ y comienza el robo"
Config.GuardsNotKilledYet = "Saca al ~b~conductor~s~ y/o al ~b~pasajero~s~ del ~y~Furgón Blindado~s~"
Config.TruckIsNotStopped = "PAra al ~y~Furgón Blindado~s~ antes de ~r~robarlo~s~!"
Config.NotEnoughMoney = "Necesitas ~g~$"..Config.MissionCost.."~s~ en tu ~b~cuenta bancaria~s~ para hacer la ~y~misión~s~"
