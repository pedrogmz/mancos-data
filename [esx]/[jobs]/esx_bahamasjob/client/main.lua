...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = _U('chofer_outfit'),    value = 'chofer_outfit'},
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu)
			...
			if data.current.value == 'chofer_outfit' then
				setUniform(data.current.value, playerPed)
				isSecurity = true
			end
...
function OpenBillingMenu()
	ESX.UI.Menu.CloseAll()
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing_bahamas_service', {
		...
		if amount == nil then
			...
			if closestPlayer == -1 or closestDistance > 3.0 then
				...
				TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_bahamas', 'Cocteleria', amount)
...
AddEventHandler('esx_bahamasjob:hasEnteredMarker', function(zone)
		...
		if zone == 'Flacons' or zone == 'Flacons2' or zone == 'Apero' or zone == 'Apero2' then
