...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('esx_bahamasmafia:getStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					TriggerServerEvent('esx_bahamasmafia:getStockItem', itemName, count)
					Citizen.Wait(1000)
					OpenGetStocksMenu()
				end
...
function OpenPutStocksMenu()
	ESX.TriggerServerCallback('esx_bahamasmafia:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					-- todo: refresh on callback
					TriggerServerEvent('esx_bahamasmafia:putStockItems', itemName, count)
					Citizen.Wait(1000)
					OpenPutStocksMenu()
				end
			end, function(data2, menu2)
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_bahamasmafia:getFridgeStockItems', function(items)
		...
		ESX.UI.Menu.Open(
		  ...
		  function(data2, menu2)
			...
			if count == nil then
			  ...
			  TriggerServerEvent('esx_bahamasmafia:getFridgeStockItem', itemName, count)
			end
		...
		ESX.UI.Menu.Open(
		  ...
		  function(data2, menu2)
			...
			if count == nil then
			  ...
			  TriggerServerEvent('esx_bahamasmafia:putFridgeStockItems', itemName, count)
			end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_bahamasmafia:getVaultWeapons', function(weapons)
	...
	ESX.UI.Menu.Open(
	  ...
	  function(data, menu)
		...
		ESX.TriggerServerCallback('esx_bahamasmafia:removeVaultWeapon', function()
  ...
  ESX.UI.Menu.Open(
	...
	function(data, menu)
	  ...
	  if data.current.type == 'item_weapon' then
		...
		ESX.TriggerServerCallback('esx_bahamasmafia:addVaultWeapon', function()
		  ESX.SetTimeout(300, function()
			OpenVaultMenu()
		  end)
		end, data.current.type, data.current.value, data.current.ammo)
...
function OpenShopMenu(zone)
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu)
			TriggerServerEvent('esx_bahamasmafia:buyItem', data.current.value, data.current.price, data.current.realLabel)
		end,
		function(data, menu)
			menu.close()
		end
...
AddEventHandler('esx_bahamasmafia:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_bahamasmafia:hasExitedMarker', function(zone)
	CurrentAction = nil
	ESX.UI.Menu.CloseAll()
end)
	...
	while true do
		...
		if IsJobTrue() then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('esx_bahamasmafia:hasEnteredMarker', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('esx_bahamasmafia:hasExitedMarker', LastZone)
			end
...
AddEventHandler('esx_bahamasmafia:teleportMarkers', function(position)
	...
	--if IsJobTrue() then
		...
		if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
		  ...
		  if status == 'in'  then
			...
			ESX.TriggerServerCallback('esx_bahamasmafia:keycount', function(count)
			  if count > 0 then
				TriggerEvent('esx_bahamasmafia:teleportMarkers', position)
			  else 
