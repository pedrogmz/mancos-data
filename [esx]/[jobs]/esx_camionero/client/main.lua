...
function MenuVehicleSpawner()
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu)
			ESX.Game.SpawnVehicle(data.current.value, Config.Zones.VehicleSpawnPoint.Pos, 89.71, function(vehicle)
				...
				if data.current.value == 'phantom3' then
					ESX.Game.SpawnVehicle("trailers22", Config.Zones.VehicleSpawnPoint.Pos, 89.71, function(trailer)
					    AttachVehicleToTrailer(vehicle, trailer, 1.1)
					end)
				end	
				if data.current.value == 'phantom' then
					ESX.Game.SpawnVehicle("trailers2", Config.Zones.VehicleSpawnPoint.Pos, 89.71, function(trailer)
					    AttachVehicleToTrailer(vehicle, trailer, 1.1)
					end)
				end	
				...
				if data.current.value == 'packer' then
					ESX.Game.SpawnVehicle("trailers2", Config.Zones.VehicleSpawnPoint.Pos, 89.71, function(trailer)
					    AttachVehicleToTrailer(vehicle, trailer, 0.0)
					end)
				end					
