...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'priche' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function IsBossAdalid()
    if PlayerData ~= nil then
        local IsBossAdalid = false
        if PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'viceboss' or PlayerData.job.grade_name == 'pricheadalid' then
            IsBossAdalid = true
        end
        return IsBossAdalid
    end
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('skin_1'),    value = 'skin_1'},
    { label = _U('skin_2'),  value = 'skin_2'},
    { label = _U('skin_3'),  value = 'skin_3'},
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if
        data.current.value == 'skin_1' or
        data.current.value == 'skin_2' or
        data.current.value == 'skin_3'
      then
        setUniform(data.current.value, playerPed)
      end
...
function OpenhelicopteroSpawnerMenu()
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'priche', vehicleProps)
        ...
        if not DoesEntityExist(vehicle) then
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle(model, {
              ...
              TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1) -- teleportar para o veículo
...
function OpenSocietyActionsMenu()
  ...
  table.insert(elements, {label = _U('acciones'),    value = 'citizen_interaction'})
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'priche_actions',
    {
      title    = _U('priche'),
      align    = 'top-left',
      elements = elements
	...
	if data.current.value == 'citizen_interaction' then
        ...
        {label = _U('uncuff'),    value = 'uncuff'},
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						TriggerServerEvent('esx_priche:message', GetPlayerServerId(closestPlayer), _U('being_searched'))
          ...
          if distance <= 2.0 then
            TriggerServerEvent('esx_priche:requestarrest', target_id, playerheading, playerCoords, playerlocation)
          else
          ...
          playerCoords = GetEntityCoords(GetPlayerPed(-1))
          local target_id = GetPlayerServerId(target)
          TriggerServerEvent('esx_priche:requestrelease', target_id, playerheading, playerCoords, playerlocation)
					elseif action == 'drag' then
						TriggerServerEvent('esx_priche:drag', GetPlayerServerId(closestPlayer))
					elseif action == 'put_in_vehicle' then
						TriggerServerEvent('esx_priche:putInVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'out_the_vehicle' then
						TriggerServerEvent('esx_priche:OutVehicle', GetPlayerServerId(closestPlayer))
					end
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              'default', GetCurrentResourceName(), 'menu_crafting',
              {
                  ...
                  align = 'top-left',
                  elements = {
                      {label = _U('pistola'),     value = 'pistola'},
                      {label = _U('microsmg'),         value = 'microsmg'},
                      {label = _U('kelvar'),    value = 'kelvar'},
                      {label = _U('rifleasalto'),   value = 'rifleasalto'},
                  }
              },
              function(data2, menu2)
            
                TriggerServerEvent('esx_priche:craftingCoktails', data2.current.value)
...
function OpenIdentityCardMenu(player)
	...
	ESX.TriggerServerCallback('esx_priche:getOtherPlayerData', function(data)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_priche', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_priche:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_priche:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_priche:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_priche:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_priche:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_priche:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_priche:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_priche:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_priche:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_priche:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'priche_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_priche:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_priche:hasEnteredMarker', function(zone)
	...
	if zone == 'Armario' then
      CurrentAction     = 'menu_armario'
      CurrentActionMsg  = _U('open_cloackroom')
      CurrentActionData = {}
    end

    if Config.EnableVaultManagement then
      if zone == 'Vaults' and IsBossAdalid() then
        CurrentAction     = 'menu_vault'
        CurrentActionMsg  = _U('open_vault')
        CurrentActionData = {}
      end
    ...
    if Config.EnableHelicopters then
        if zone == 'Helicopters' and IsGradeBoss() then
                CurrentAction     = 'menu_helicoptero'
                CurrentActionMsg  = _U('open_heli')
                CurrentActionData = {}
    end
...
AddEventHandler('esx_priche:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_priche:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_priche:hasExitedMarker', LastZone)
            end
...
RegisterNetEvent('esx_priche:handcuff')
AddEventHandler('esx_priche:handcuff', function()
...
RegisterNetEvent('esx_priche:unrestrain')
AddEventHandler('esx_priche:unrestrain', function()
	if IsHandcuffed then
		local playerPed = PlayerPedId()
		IsHandcuffed = false
...
RegisterNetEvent('esx_priche:drag')
AddEventHandler('esx_priche:drag', function(copID)
...
RegisterNetEvent('esx_priche:putInVehicle')
AddEventHandler('esx_priche:putInVehicle', function()
	local playerPed = PlayerPedId()
...
RegisterNetEvent('esx_priche:OutVehicle')
AddEventHandler('esx_priche:OutVehicle', function()
	local playerPed = PlayerPedId()
...
-- test 
RegisterNetEvent('esx_priche:getarrested')
AddEventHandler('esx_priche:getarrested', function(playerheading, playercoords, playerlocation)
  ...
  Citizen.Wait(3760)
  IsHandcuffed = true
  TriggerEvent('esx_priche:handcuff')
  loadanimdict('mp_arresting')
  TaskPlayAnim(GetPlayerPed(-1), 'mp_arresting', 'idle', 8.0, -8, -1, 49, 0.0, false, false, false)
end)

RegisterNetEvent('esx_priche:doarrested')
AddEventHandler('esx_priche:doarrested', function()
  Citizen.Wait(250)
  loadanimdict('mp_arrest_paired')
...
RegisterNetEvent('esx_priche:douncuffing')
AddEventHandler('esx_priche:douncuffing', function()
  Citizen.Wait(250)
  loadanimdict('mp_arresting')
...
RegisterNetEvent('esx_priche:getuncuffed')
AddEventHandler('esx_priche:getuncuffed', function(playerheading, playercoords, playerlocation)
  local x, y, z   = table.unpack(playercoords + playerlocation * 1.0)
  SetEntityCoords(GetPlayerPed(-1), x, y, z)
  SetEntityHeading(GetPlayerPed(-1), playerheading)
  Citizen.Wait(250)
...
AddEventHandler('playerSpawned', function(spawn)
	isDead = false
	TriggerEvent('esx_priche:unrestrain')
	
	if not hasAlreadyJoined then
		TriggerServerEvent('esx_priche:spawned')
	end
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		TriggerEvent('esx_priche:unrestrain')
		TriggerEvent('esx_phone:removeSpecialContact', 'motoclub')

		if Config.MaxInService ~= -1 then
			TriggerServerEvent('esx_service:disableService', 'motoclub')
		end
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
		...
		if CurrentAction == 'menu_armario' then
            OpenArmarioMenu()
        end
        ...
        if CurrentAction == 'menu_helicoptero' then
            OpenhelicopteroSpawnerMenu()
        end
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'priche', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'priche')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'priche', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'priche_actions') then
...
AddEventHandler('esx_priche:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('esx_priche:teleportMarkers', position)
        end
