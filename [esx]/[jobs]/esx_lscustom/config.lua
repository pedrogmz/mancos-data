...
Config.Zones = {
	...
	ls1 = {
		...
		ls4 = {
	    Pos   = { x = 103.34, y = 6622.99, z = 31.33},
		Size  = {x = 1.0, y = 1.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
		...
		ls5 = {
	    Pos   = { x = 1175.49, y = 2638.94, z = 37.26},
		Size  = {x = 1.0, y = 1.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Blip = false,
...
Config.Menus = {
	...
	cosmetics = {
		...
		modDoorSpeaker		= _U('door_speakers'), -- altavoces puertas
		modSeats			= _U('seats'), -- asientos
		modSteeringWheel	= _U('steering_wheel'), -- volante
		modShifterLeavers	= _U('gear_lever'), -- palanca de cambios
		modAPlate			= _U('quarter_deck'), -- cubierta
		modSpeakers			= _U('speakers'), -- altavoces
		modTrunk			= _U('trunk'), -- maletero
		modHydrolic			= _U('hydraulic'), -- hidráulica
		modEngineBlock		= _U('engine_block'), -- motor
		modAirFilter		= _U('air_filter'), -- filtro aire
		modStruts			= _U('struts'), -- puntales
		modArchCover		= _U('arch_cover'), -- cubierta
		modAerials			= _U('aerials'), -- antenas
		modTrimB			= _U('wings'), -- alas
		modTank				= _U('fuel_tank'), -- depósito
		modWindows			= _U('windows'), -- ventanas (VIP)
		modLivery			= _U('stickers') -- pegatinas
	},
