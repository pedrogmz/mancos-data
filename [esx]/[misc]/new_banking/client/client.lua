...
local atms = {
  ...
  --{name="ATM", id=277, x=-373.0419, y=-132.6321, z=37.7279},
  {name="ATM", id=277, x=-1391.04, y=-590.32, z=30.32}, --Bahamas
  --{name="ATM", id=277, x=937.93, y=-55.06, z=79.83}, --Evento 24/10
  --{name="ATM", id=277, x=967.28, y=26.59, z=105.02}, -- Evento 24/10
}
--================================================================================================
...
--==         Change coins Event                    ==
--===============================================
RegisterNUICallback('change_drs', function(data)
	TriggerServerEvent('bank:change_drs', tonumber(data.amount_drs))
	TriggerServerEvent('bank:balance')
end)
