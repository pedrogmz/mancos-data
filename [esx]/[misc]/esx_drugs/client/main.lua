...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(coords, Config.CircleZones.DrugDealer.coords, true) < 0.5 or (GetDistanceBetweenCoords(coords, Config.CircleZones.DrugDealerCoke.coords, true) < 0.5 and ESX.GetPlayerData().job.name == "medellin") then
