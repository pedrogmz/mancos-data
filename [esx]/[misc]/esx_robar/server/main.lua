...
AddEventHandler('esx_robar:putInVehicle', function(target)
	TriggerClientEvent('esx_robar:putInVehicle', target)
end)

RegisterServerEvent('esx_robar:OutVehicle')
AddEventHandler('esx_robar:OutVehicle', function(target)
	TriggerClientEvent('esx_robar:OutVehicle', target)
end)
