					...
					if DoesEntityExist(value.id) then
						...
						if AnimalHealth <= 0 then
							...
							if PlyToAnimal < 2.0 then
								...
								ESX.Game.Utils.DrawText3D({x = AnimalCoords.x, y = AnimalCoords.y, z = AnimalCoords.z + 1}, '[E] Cazar animal', 0.4)
...
function SlaughterAnimal(AnimalId)
	...
	ESX.ShowNotification('Has cazado un animal y recibido ' ..AnimalWeight.. 'kg de carne')
