...
function CreateNPC(type, model, anim, dict, pos, help, key, range, start, finish)
	...
	-- Creates ped when everything is loaded
		local ped = CreatePed(type, hash, pos.x, pos.y, pos.z, pos.h, false, false)
...
CreateNPC(
	...
	"base",
	--{x = 239.471, y = -1380.96, z = 32.74176, h = 137.6},
	{x = 299.12, y = -790.77, z = 28.48},
	"Press ~INPUT_CONTEXT~ to interact with ~y~NPC",
	{1, 38},
	3,
	function()
		Citizen.Wait(500)
