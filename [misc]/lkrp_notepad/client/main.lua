...
RegisterNUICallback('droppingEmpty', function(data, cb)
    print('No puedes dejar el bloc de notas vacío.')
end)
    ...
    while true do
        ...
        if #TestLocalTable == 0 then
            ...
            if distance < 2.0 then
                ...
                DrawText3Ds(TestLocalTable[closestNoteId]["x"],TestLocalTable[closestNoteId]["y"],TestLocalTable[closestNoteId]["z"]-0.4, "~g~E~s~ para leer,~g~H~s~ para borrar.")
