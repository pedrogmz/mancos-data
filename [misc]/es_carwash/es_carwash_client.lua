...
vehicleWashStation = {
	...
	{1712.9, 3776.84, 33.85},
	--{918.89, -100.38, 76.80}--Evento 24/10
}
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), garageCoords2[1], garageCoords2[2], garageCoords2[3], true ) < 5 then
					...
					if not hasShownNotification[i] then
						TriggerEvent("pNotify:SendNotification",{
							text = "<font color=lightblue>Car Wash</font>:<br /> Bienvenid@!<br />Presiona <font color=lightgreen>ENTER</font> para lavar tu vehículo.",
							type = "error",
							timeout = (7000),
							layout = "centerLeft",
							queue = "global"
...
AddEventHandler('es_carwash:success', function (price)
	...
	TriggerEvent("pNotify:SendNotification",{
            text = "<font color=lightblue>Car Wash</font>:<br />¡Los limpiamos para ti!<br />Va a costar $<font color=lightgreen>" .. price .. ".00</font> por favor.",
            type = "error",
            timeout = (7000),
            layout = "centerLeft",
            queue = "global"
...
AddEventHandler('es_carwash:notenoughmoney', function (moneyleft)
	...
	TriggerEvent("pNotify:SendNotification",{
            text = "<font color=lightblue>Car Wash</font>:<br /> No puede pagar nuestros precios, salga de aquí!",
            type = "error",
            timeout = (7000),
            layout = "centerLeft",
            queue = "global"
...
AddEventHandler('es_carwash:free', function ()
	...
	TriggerEvent("pNotify:SendNotification",{
            text = "<font color=lightblue>Car Wash</font>:<br />De vez en cuando, ayudamos en caso de caridad.<br />Disfruta!",
            type = "error",
            timeout = (7000),
            layout = "centerLeft",
            queue = "global"
