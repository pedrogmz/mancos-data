...
AddEventHandler('thiefInProgress', function(street1, street2, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehiculo por un ~w~"..sex.." ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de un ~w~"..veh.." ~r~por un ~w~"..sex.." ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
	end
end)
...
AddEventHandler('thiefInProgressS1', function(street1, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehiculo por un ~w~"..sex.." ~r~en ~w~"..street1)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de un ~w~"..veh.." ~r~por un ~w~"..sex.." ~r~en ~w~"..street1)
	end
end)

RegisterServerEvent('meleeInProgress')
AddEventHandler('meleeInProgress', function(street1, street2, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Pelea callejera por un ~w~"..sex.." ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
end)

RegisterServerEvent('meleeInProgressS1')
AddEventHandler('meleeInProgressS1', function(street1, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Pelea callejera por un ~w~"..sex.." ~r~en ~w~"..street1)
end)


RegisterServerEvent('gunshotInProgress')
AddEventHandler('gunshotInProgress', function(street1, street2, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Disparos por un ~w~"..sex.." ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
end)

RegisterServerEvent('gunshotInProgressS1')
AddEventHandler('gunshotInProgressS1', function(street1, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Disparos de un ~w~"..sex.." ~r~en ~w~"..street1)
end)
