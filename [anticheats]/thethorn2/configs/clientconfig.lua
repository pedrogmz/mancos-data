...
ChocoHaxCc.ResourceChecker = false -- This script is not available for now...
...
ChocoHaxCc.ResourceCounter = false -- This script will check if a player have a diffrent amount of resources
ChocoHaxCc.AntiResourceRestart = false -- This scripts will check if a player tries to restart scripts
ChocoHaxCc.AntiResourceStop = false -- This script will check if a player tries to STOP a script
ChocoHaxCc.AntiFCommands = false -- This script will check if a player injected custom commands into the server
