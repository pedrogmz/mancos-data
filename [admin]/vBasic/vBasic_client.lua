...
-- Citizen.CreateThread(function()
	-- while true do
		-- SetVehicleDensityMultiplierThisFrame(200.10)
		-- SetPedDensityMultiplierThisFrame(30.10)
		-- SetRandomVehicleDensityMultiplierThisFrame(200.2)
		-- SetParkedVehicleDensityMultiplierThisFrame(9000.10)
		-- SetScenarioPedDensityMultiplierThisFrame(99.9, 99.9)
