...
RegisterServerEvent("MANCOS:playerKicked")
AddEventHandler("MANCOS:playerKicked", function(src, points)
...
RegisterServerEvent("MANCOS:playerConnected")
AddEventHandler("MANCOS:playerConnected", function()
