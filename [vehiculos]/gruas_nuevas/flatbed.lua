...
AddTextEntry(controllerMessageLoweredCar, "Pulsa ~INPUT_CONTEXT~ para subir la grúa.~n~Pulsa ~INPUT_DETONATE~ para desatar el vehículo.")
AddTextEntry(controllerMessageLoweredNoCar, "Pulsa ~INPUT_CONTEXT~ para bajar la grúa.~n~Pulsa ~INPUT_DETONATE~ para atar el vehículo")
AddTextEntry(controllerMessageRaised, "Pulsa ~INPUT_CONTEXT~ para bajar la grúa")
